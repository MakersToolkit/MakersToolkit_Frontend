    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      <div className="z-10 container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Embark on an interstellar journey through the universe, discovering celestial wonders and cosmic phenomena beyond imagination.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Button className="bg-gradient-to-r from-cosmic-stardust-teal to-cosmic-galaxy-violet text-white px-8 py-6 rounded-md hover:opacity-90 transition-opacity w-full sm:w-auto text-lg">
            Begin Journey
          </Button>
          <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 px-8 py-6 rounded-md transition-colors w-full sm:w-auto text-lg">
            Discover More
          </Button>
        </div>
      </div>
